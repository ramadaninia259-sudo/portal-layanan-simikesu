...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 11, 2026 at 06:43 AM
...
CREATE TABLE `tb_permohonan` (
  ...
  `status` enum('Menunggu Verifikasi','Perbaikan Berkas','Diterima') DEFAULT 'Menunggu Verifikasi',
